namespace Caliburn.PresentationFramework.ApplicationModel
{
    ...
    public abstract class PresenterBase : MetadataContainer, IExtendedPresenter
    {
        ...
        /// <summary>
        /// Called when the presenter's view is unloaded.
        /// </summary>
        /// <param name="view">The view.</param>
        /// <param name="context">The context.</param>
        public virtual void ViewUnloaded(object view, object context) { }
        ...
        public virtual void Close()
        {
            ...
            else
            {
                ...
                if (view == null)
                {
                    throw new NotSupportedException("You cannot close an instance without a parent or a default view.");
                }
