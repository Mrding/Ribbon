    ...
    public partial class SelectorSelectionAdapter : ISelectionAdapter
    {
        ...
        protected void SelectedIndexIncrement()
        {
            if (SelectorControl != null)
            {
                ...
                Application.Current.Dispatcher.BeginInvoke(System.Windows.Threading.DispatcherPriority.Render, (Action)delegate()
                {
                    (SelectorControl as System.Windows.Controls.ListBox).ScrollIntoView(SelectorControl.SelectedItem);
                });
