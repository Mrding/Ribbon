namespace Caliburn.PresentationFramework.Parsers
{
    ...
    /// <summary>
    /// An implementation of <see cref="ITriggerParser"/> that parses standard events.
    /// </summary>
    public class EventTriggerParser : ITriggerParser
    {
        /// <summary>
        ...
        {
            return new EventMessageTrigger {EventName = triggerText};
        }
    }
}