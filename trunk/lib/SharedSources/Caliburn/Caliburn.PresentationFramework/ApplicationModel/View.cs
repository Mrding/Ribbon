namespace Caliburn.PresentationFramework.ApplicationModel
{
    ...
    public static class View
    {
        ...
        {
            //Caliburn.Core.Invocation.Execute.OnUIThread(() =>
            //{
            ...
            if (e.NewValue != null)
            {
                ...
                {
                    (e.NewValue as IPresenter).Initialize();
                }
        ...
        private static void OnContextChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (model is IPresenter)
            {
                (model as IPresenter).Initialize();
            }
        ...
        {
            if (d == view) return;
            var contentProperty = d.GetType().GetAttributes<ContentPropertyAttribute>(true)
